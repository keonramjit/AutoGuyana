            ...
            <div className="hidden lg:flex lg:w-1/2 bg-blue-900 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 text-white">
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl font-bold mb-2">Guyana's Premium Marketplace</h1>
                        <h2 className="text-2xl font-light text-blue-200">Drive Your Dream Today</h2>
                    </div>
                    <p className="text-lg text-blue-100 mb-8 max-w-md leading-relaxed">
                        Connect with trusted dealers and private sellers across Georgetown, Berbice, and beyond.
                    </p>
